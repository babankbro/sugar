...
class SurgarProblem(ElementwiseProblem):
    ...
    def __init__(self, dataset_lookups):
        ...
        self.Leaf_Rate = self.dataset_lookups["LEAF_RATE_RAI"]


    def _evaluate(self, x, out, *args, **kwargs):
        
        meta_infos = self.decoder.decode(x, False)
        ...
        rinfoss = [rinfos1, rinfos2, rinfos3, rinfos4]
        ...
        if rinfos1 == None:
            ...
            isComplete = True
            for rinfos in rinfoss:
                for rinfo in rinfos:
                    if len(rinfo['route']) != len(rinfo['dt']):
                        isComplete = False
                        break
            ...
            if isComplete:
                cost = meta_infos['cost_data']['total_transport_cost']
                profit = meta_infos['cost_data']['profit']
            else:
                cost = 10000000000
                profit = 0
